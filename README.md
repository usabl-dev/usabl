...
| ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `usabl check`                         | The gate. Scans the affected screens (and docs pages when `usabl.docs.json` is present) and returns one verdict with its exit code. This is the default command.                                                                                                                                                                                                                                                                                    |
