...
export async function collectDoctorReport(deps: DoctorDeps): Promise<SurfaceReport[]> {
  ...
  // evidence floor, waivers, overlay, stop hook, usabl-check skill, ci workflow, branch rule.
  // The session sits second because it decides what every later scan actually measures. Each
